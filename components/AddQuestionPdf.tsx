...
import { Button, createStyles, makeStyles, Theme, Typography, TextField } from "@material-ui/core";
...
interface Props {
  ...
  handleRemoveFileClick: (index: number, event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => void
}
